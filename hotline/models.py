...
class ScanHotline(models.Model):
    pub_date = models.DateTimeField(default=datetime.date.today, blank=True, verbose_name="Дата публикации")
...
class OneHotline(models.Model):
    ...
    # name = models.CharField(max_length=250, verbose_name="Название")
    # requery = models.BooleanField(verbose_name="Обязателен")
...
class ConcurentHotline(models.Model):
    ...
    # min = models.IntegerField(verbose_name="itemid", default=0)
    # ordering = models.IntegerField(verbose_name="Порядок сортировки", default=0, blank=True, null=True)
    # slug = models.CharField(max_length=250, blank=True, verbose_name="Урл")
    # def __unicode__(self):
    #     return self.name
